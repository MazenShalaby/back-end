...
from .models import DoctorsProfileInfo, Appointment,  DoctorAvailableBooking, ActivityFeed, UserLogin , PreviousHistory, UploadedPhoto
from .serilaizers import  DoctorInfoSerializer, AppointmentSerializer, DoctorAVailableBookingSerializer, ActivityFeedSerializer, LoginSerializer ,PreviousHistorySerializer, UploadedPhotoSerializer
